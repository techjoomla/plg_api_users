...
class JFormFieldIntegration extends JFormField
{
	...
	public function fetchElement($name, $value, $node, $control_name)
	{
		...
		$options[] = JHTML::_('select.option', 'joomla', JText::_('PLG_USER_API_JOOMLA'));
	/*	$options[] = JHTML::_('select.option', 'jomsocial', JText::_('PLG_USER_API_JOMSOCIAL'));	*/
		$options[] = JHTML::_('select.option', 'easysocial', JText::_('PLG_USER_API_EASYSOCIAL'));
