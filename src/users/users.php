...
class UsersApiResourceUsers extends ApiResource
{
	...
	public function get()
	{
		...
		if ($id = $input->get('id'))
		{
			...
			$user = $this->getUserCustomFieldData($user);
	...
	/**
	 * This function return the user respective custom field data
	 *
	 * @param   String  $user  User
	 *
	 * @return Object user
	 */
	public function getUserCustomFieldData($user)
	{
		...
		if (!empty($userFields))
		{
			...
			{
				$userCustomFields[$field->name] = $field->rawvalue;
			}

			$user->customField = $userCustomFields;
		}
